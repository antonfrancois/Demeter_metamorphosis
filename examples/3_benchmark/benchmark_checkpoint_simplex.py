...
for save_gpu in [False, True]:
    for size in size_list:
        ...
        print("python3",
             "examples/3_benchmark/execute_simplex_pixyl.py",
            "--width", str(size),
            "--height", str(size),
...
plt.tight_layout()
img_path = os.path.join(os.path.dirname(csv_file),f"benchmark_plot_memory_simplex.png")
plt.show()
