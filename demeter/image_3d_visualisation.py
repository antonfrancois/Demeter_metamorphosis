...
from constants import DLT_KW_RESIDUALS
from metamorphosis import Optimize_metamorphosis,Residual_norm_function
...
class Visualize_geodesicOptim:
    ...
    def __init__(self,geoShoot : Optimize_metamorphosis,
                 alpha = 0.8,
